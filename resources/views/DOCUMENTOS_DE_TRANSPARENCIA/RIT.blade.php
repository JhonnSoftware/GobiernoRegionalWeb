...
@section('contenido-principal')
    ...
    <div class="banner fade-in">
        <h1>REGLAMENTO INTERNO DE TRABAJO<br>(RIT)</h1>
    </div>
        ...
        <div class="mt-3">
            <div class="event-card">
                ...
                <div class="event-info">
                    ...
                    <span class="event-title">Reglamento Interno de Trabajo (Vigente)</span><br>
                    <small>20 MB</small>
                </div>
            ...
            <div class="event-card">
                ...
                <div class="event-info">
                    ...
                    <span class="event-title">Reglamento Interno de Trabajo</span><br>
                    <small>9.9 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
