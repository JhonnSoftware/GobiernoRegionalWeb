...
@section('title', 'Resoluciones Gerenciales Regionales de Planeamiento, Presupuesto y acondicionamiento territorial')
...
@section('contenido-principal')
    ...
    <div class="banner">
        <h1>RESOLUCIONES GERENCIALES REGIONALES DE PLANEAMIENTO<br>PRESUPUESTO Y ACONDICIONAMIENTO TERRITORIAL</h1>
    </div>
    ...
    <div class="container mt-4">
        ...
        <div class="mt-3">
            ...
            <div class="event-card">
                ...
                <div class="event-info">
                    <small>21/02/2025</small><br>
                    <span class="event-title">RESOLUCIÓN GERENCIAL REGIONAL DE PLANEAMIENTO, PRESUPUESTO Y ACONDICIONAMIENTO 
                        TERRITORIAL N° 001-2025-GRJ/GRPPAT</span><br>
                    <small>7.5 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
            ...
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white" style="padding:20px;"></i></div>
                <div class="event-info">
                    <small>28/12/2024</small><br>
                    <span class="event-title">RESOLUCIÓN GERENCIAL REGIONAL DE PLANEAMIENTO, PRESUPUESTO Y ACONDICIONAMIENTO 
                        TERRITORIAL N° 057-2024-GRJ/GRPPAT</span><br>
                    <small>3.2 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
            ...
            <div class="event-card">
                ...
                <div class="event-info">
                    ...
                    <span class="event-title">RESOLUCIÓN GERENCIAL REGIONAL DE PLANEAMIENTO, PRESUPUESTO Y ACONDICIONAMIENTO 
                        TERRITORIAL N° 056-2024-GRJ/GRPPAT</span><br>
                    <small>1.9 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
            ...
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white" style="padding:20px;"></i></div>
                <div class="event-info">
                    <small>15/11/2024</small><br>
                    <span class="event-title">RESOLUCIÓN GERENCIAL REGIONAL DE PLANEAMIENTO, PRESUPUESTO Y ACONDICIONAMIENTO 
                        TERRITORIAL N° 055-2024-GRJ/GRPPAT</span><br>
                    <small>2.6 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
            ...
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white" style="padding:20px;"></i></div>
                <div class="event-info">
                    <small>14/11/2024</small><br>
                    <span class="event-title">RESOLUCIÓN GERENCIAL REGIONAL DE PLANEAMIENTO, PRESUPUESTO Y ACONDICIONAMIENTO 
                        TERRITORIAL N° 054-2024-GRJ/GRPPAT</span><br>
                    <small>7.1 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
            ...
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white" style="padding:20px;"></i></div>
                <div class="event-info">
                    <small>30/10/2024</small><br>
                    <span class="event-title">RESOLUCIÓN GERENCIAL REGIONAL DE PLANEAMIENTO, PRESUPUESTO Y ACONDICIONAMIENTO 
                        TERRITORIAL N° 053-2024-GRJ/GRPPAT</span><br>
                    <small>2.7 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
            ...
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white" style="padding:20px;"></i></div>
                <div class="event-info">
                    <small>29/10/2024</small><br>
                    <span class="event-title">RESOLUCIÓN GERENCIAL REGIONAL DE PLANEAMIENTO, PRESUPUESTO Y ACONDICIONAMIENTO 
                        TERRITORIAL N° 052-2024-GRJ/GRPPAT</span><br>
                    <small>1012.9 KB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
            </div>
            <div class="event-card">
                ...
                <div class="event-info">
                    ...
                    <span class="event-title">RESOLUCIÓN GERENCIAL REGIONAL DE PLANEAMIENTO, PRESUPUESTO Y ACONDICIONAMIENTO 
                        TERRITORIAL N° 050-2024-GRJ/GRPPAT</span><br>
                    <small>990.8 KB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
            </div>
