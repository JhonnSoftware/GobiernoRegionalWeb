...
@section('contenido-principal')
    ...
    <div class="banner fade-in">
        <h1>PRESUPUESTO ANALITICO<br>DE PERSONAL (PAP)</h1>
    </div>
    ...
    <div class="container mt-4 fade-in">
        <div class="header-alert text-center">
            <strong>PAP SEDE REGIONAL (VIGENTE)</strong><br>
        </div>
        ...
        <div class="mt-3">
            <div class="event-card">
                ...
                <div class="event-info">
                    ...
                    <span class="event-title">Presupuesto Analitico de Personal 2021 (VIGENTE)</span><br>
                    <small>4.5 MB</small>
                </div>
        ...
        <div class="header-alert text-center">
            <strong>PAP SEDE REGIONAL (HISTORICO)</strong><br>
        </div>
        <div class="mt-3">
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white"></i></div>
                <div class="event-info">
                    <small>26/02/2020</small><br>
                    <span class="event-title">Presupuesto Analitico de Personal 2018</span><br>
                    <small>6.2 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
        ...
        <div class="mt-3">
            <div class="event-card">
                ...
                <div class="event-info">
                    ...
                    <span class="event-title">Presupuesto Analitico de Personal 2006</span><br>
                    <small>2.2 MB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #1356b3;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #1356b3;"></a>
