...
@section('contenido-principal')
    ...
    <div class="banner">
        <h1>REGLAMENTO DE ORGANIZACIÓN<br>Y FUNCIONES (ROF)</h1>
    </div>
    ...
    <div class="container mt-4">
        <div class="header-alert text-center">
            <strong>ROF SEDE REGIONAL (VIGENTE HASTA LA FECHA)</strong><br>
        </div>
        <div class="mt-3">
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white"></i></div>
                <div class="event-info">
                    <small>04/12/2024</small><br>
        ...
        <div class="header-alert text-center">
            <strong>ROF SEDE REGIONAL (HISTÓRICO)</strong><br>
        </div>
        <div class="mt-3">
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white"></i></div>
        ...
        <div class="header-alert text-center">
            <strong>ROF - DIRECCIONES REGIONALES</strong><br>
        </div>
        <div class="mt-3">
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white"></i></div>
