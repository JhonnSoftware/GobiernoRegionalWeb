...
@section('title', 'Plan de Prevencion ante Desastres')
...
@section('contenido-principal')
    ...
    <div class="banner">
        <h1>PLAN DE PREVENCION ANTE <br>DESASTRES</h1>
    </div>
        ...
        <div class="mt-3">
            <div class="event-card">
                ...
                <div class="event-info">
                    <small>30/09/2024</small><br>
                    <span class="event-title">PLAN DE PREVENCIÓN Y REDUCCIÓN DE RIESGO DE DESASTRES ANTE INCENDIOS 
                        FORESTALES DEL DEPARTAMENTO DE JUNIN 2024-2030</span><br>
                    <small>16.1 MB</small>
                </div>
