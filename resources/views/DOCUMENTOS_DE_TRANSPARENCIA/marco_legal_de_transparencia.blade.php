...
@section('contenido-principal')
    ...
    <div class="banner fade-in">
        <h1>MARCO LEGAL DE TRANSPARENCIA</h1>
    </div>
        ...
        <div class="mt-3">
            <div class="event-card">
                ...
                <div class="event-info">
                    <small>23/04/2024</small><br>
                    <span class="event-title">Ley Nª 31783 que modifica la Ley 27806. Ley de Transparencia y Acceso a la Información Pública (VIGENTE)</span><br>
                    <small>558.4 KB</small>
                </div>
            ...
            <div class="event-card">
                <div class="event-icon"><i class="fa-solid fa-file-pdf text-white" style="padding:20px;"></i></div>
                <div class="event-info">
                    <small>27/07/2015</small><br>
                    <span class="event-title">Ley que Modifica la Ley Nº 27806, Ley de Transparencia y Acceso a la Información Pública</span><br>
                    <small>313.7 KB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #ff6700;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #ff6700;"></a>
            </div>
            <div class="event-card">
                ...
                <div class="event-info">
                    <small>27/07/2015</small><br>
                    <span class="event-title">Reglamento de la Ley de Transparencia y Acceso a la Información Pública</span><br>
                    <small>90.2 KB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #ff6700;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #ff6700;"></a>
            ...
            <div class="event-card">
                ...
                <div class="event-info">
                    <small>27/07/2015</small><br>
                    <span class="event-title">Aprobación del Texto Único Ordenado de la Ley Nº27806, Ley de Transparencia y Acceso a la Información Pública</span><br>
                    <small>66.9 KB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #ff6700;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #ff6700;"></a>
            ...
            <div class="event-card">
                ...
                <div class="event-info">
                    <small>27/07/2015</small><br>
                    <span class="event-title">Aprobación del Reglamento de la Ley de Transparencia y Acceso a la Información Pública</span><br>
                    <small>127.3 KB</small>
                </div>
                <a href="" class="bi bi-download fs-3 me-3" style="color: #ff6700;"></a>
                <a href="" class="bi bi-folder fs-3" style="color: #ff6700;"></a>
            </div>
