...
@section('contenido-principal')
    ...
    <div class="container fade-in">
        <div class="mensaje">
            <h2 style="font-weight:bold; color:#1256b0; text-align: center;">ING. EDWIN ERNESTO RAMON QUISPE </h2>
    ...
    <div class="contenedor-mv fade-in">
        <div class="container2">
            <div class="texto">
                <h2>VISIÓN</h2>
                <p style="text-align: justify; margin: 0 30px;">“Hacer del Gobierno Regional Junín una organización al servicio del ciudadano ”</p>
            </div>
        ...
        <div class="container1">
            <div class="texto">
                <h2>MISIÓN</h2>
                <p style="text-align: justify; margin: 0 30px;">“Ser una oficina transparente y confiable del Gobierno Regional Junín”</p>  
            </div>
