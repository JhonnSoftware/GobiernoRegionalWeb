...
@section('title', 'Direccion Regional de Trabajo y Promocion del Empleo')
...
@section('contenido-principal')
    ...
    <div class="banner">
        <h1> DIRECCION REGIONAL DE <br> TRABAJO Y PROMOCION DEL EMPLEO </h1>
    </div>
    <div class="container">
        <div class="mensaje">
            <h2 style="font-weight:bold; color:#1256b0; text-align: center;">ABG. DIANA ROXANA CONDE MONTOYA</h2>
            <p style="font-weight: bold; font-size: 19px; color: #ff6700; text-align: center;">dconde@regionjunin.gob.pe</p>
            <p>
                La Dirección Regional de Trabajo y Promoción del Empleo está dirigida por un Director Regional, quien es
        ...
        <aside class="sidebar">
            ...
            <h2>Visitanos</h2>
            <ul>
                <li><a href="https://web.facebook.com/TrabajoJuninOficial?ref=embed_page">Facebook</a></li>
            </ul>
        </aside>
