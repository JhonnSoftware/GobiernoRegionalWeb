...
@section('title', 'Direccion Regional de Energia y Minas')
...
@section('contenido-principal')
    ...
    <div class="banner fade-in">
        <h1> DIRECCION REGIONAL DE <br> ENERGIA Y MINAS </h1>
    </div>
    <div class="container fade-in">
        <div class="mensaje">
            <h2 style="font-weight:bold; color:#1256b0; text-align: center;">ING. RODOLFO ROLANDO CANO ANDRADE</h2>
            <p style="font-weight: bold; font-size: 19px; color: #ff6700; text-align: center;">rcano@regionjunin.gob.pe</p>
            <p>
                La Dirección Regional de Energía y Minas está dirigida por un Director Regional, quien es designado por el
                Gobernador Regional.
            </p>
            <h3>Funciones</h3>
            <ul>
