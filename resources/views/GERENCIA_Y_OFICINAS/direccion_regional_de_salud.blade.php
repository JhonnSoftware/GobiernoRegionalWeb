...
@section('contenido-principal')
    ...
    <div class="banner fade-in">
        <h1> DIRECCION REGIONAL DE <br> SALUD </h1>
    </div>
    <div class="container fade-in">
        <div class="mensaje">
            <h2 style="font-weight:bold; color:#1256b0; text-align: center;">M.E. CHRISTIAN DANY MATAMOROS VERA</h2>
            <p style="font-weight: bold; font-size: 19px; color: #ff6700; text-align: center;">cmatamoros@regionjunin.gob.pe</p>
            <p>
                La Dirección Regional de Salud está dirigida por un Director Regional, quien es designado por el Gobernador
                Regional.
            </p>
            <h3>Funciones</h3>
            <ul>
        ...
        <div class="divider" style="width: 2px; background-color: #ccc; height: 700px; margin: 0 60px;"></div>
        <aside class="sidebar">
            ...
            <h2>Visitanos</h2>
            <ul>
                <li><a href="https://www.diresajunin.gob.pe/">Pagina web</a></li>
                <li><a href="https://web.facebook.com/Diresa.Junin.Oficial/?ref=embed_page#"> Facebook</a></li>
            </ul>
