...
@section('contenido-principal')
    ...
    <div class="container">
        <div class="mensaje">
            <h2>ING. RONY PAOLO VEJARANO PEREZ </h2>
            <p>
                rvejarano@regionjunin.gob.pe
            </p>
            <p>
                La Gerencia Regional de Infraestructura está encargada de formular, proponer, ejecutar, dirigir, controlar y administrar los planes y políticas de la Región en materia de transportes, comunicaciones, telecomunicaciones y construcción de acuerdo a los planes regionales, nacionales y sectoriales; así como, desarrollar funciones normativas, reguladoras, de supervisión, evaluación y control de las funciones específicas regionales en los sectores antes mencionados.             </p>
            <h3>Funciones</h3>
                <ul>
