...
@section('title', 'Direccion Regional de Produccion')
...
@section('contenido-principal')
    ...
    <div class="banner">
        <h1> DIRECCION REGIONAL DE <br> PRODUCCION </h1>
    </div>
    <div class="container">
        <div class="mensaje">
            <h2 style="font-weight:bold; color:#1256b0; text-align: center;">ING. RODOLFO JAIME ORTÍZ ZUASNABAR </h2>
            <p style="font-weight: bold; font-size: 19px; color: #ff6700; text-align: center;">rortiz@regionjunin.gob.pe</p>
            <p>
                La Dirección Regional de Producción está dirigida por un Director Regional, quien es designado por el
                Gobernador Regional.
            </p>
            <h3>Funciones</h3>
            <ul>
