...
@section('contenido-principal')
    ...
    <div class="banner fade-in">
        <h1> DIRECCION REGIONAL <br> DE AGRICULTURA </h1>
    </div>
    <div class="container fade-in">
        <div class="mensaje">
            <h2 style="font-weight:bold; color:#1256b0; text-align: center;">MG. JAIME VICTORINO AQUINO AQUINO </h2>
            <p>
                La Dirección Regional de Agricultura está dirigida por un Director Regional, quien es designado por el
                Gobernador Regional.
            </p>
            <h3>Funciones</h3>
            <ul>
                <li>Formular, aprobar, ejecutar, evaluar, dirigir, controlar y administrar los planes y políticas de la
                    región en materia agraria en concordancia con las políticas nacionales y los planes sectoriales y las
                    propuestas promocionales de desarrollo rural de parte de las municipalidades rurales.</li>
        ...
        <aside class="sidebar">
            ...
            <h2> Visitanos..</h2>
            <ul>
                <li><a href="https://www.agrojunin.gob.pe/"> Pagina web </a></li>
            </ul>
        </aside>
