                    ...
                    <a href="#" style="text-decoration: none; padding:0px; border:none;">
                        <div class="card">
                            ...
                            <p>El gobernador regional de Junín, Zósimo Cárdenas, junto con el consejero Yoner Ambicho,
                                ...
                                obra, destinada a proteger los sembríos y bienes de la población local, forma parte de
                                los
                                esfuerzos para mitigar los efectos de fenómenos naturales en la zona.
                                Durante el evento, los pobladores aprovecharon la ocasión para plantear diversas
                                solicitudes
                                ...
                                maquinaria pesada, así como la entrega de 200 bolsas de cemento, en el marco de las
                                acciones
                ...
                <div class="swiper-slide">
                    <a href="#" style="text-decoration: none; padding:0px; border:none;">
                        <div class="card">
                            ...
                            <p>Más de 55 mil habitantes del Valle de los Ríos Apurímac, Ene y Mantaro (VRAEM) pronto
                                tendrán
                                acceso a atención médica de calidad con la próxima inauguración del Hospital de Pangoa.
                                Este
                                ...
                                instalaciones.
                                El proyecto, iniciado en 2016, alcanza un avance del 90% y se encuentra en la fase
                                final, a
                                la espera de la instalación del equipamiento sanitario. Tras nueve años de espera, este
                                hospital marcará un antes y un después para las familias satipeñas, acercándolas a
                                servicios
                    ...
                    <a href="#" style="text-decoration: none; padding:0px; border:none;">
                        <div class="card">
                            ...
                            <p>Con el objetivo de garantizar el cumplimiento de plazos, el gobernador Zósimo Cárdenas
                                supervisó in situ el puente Victoria, en San Ramón. Esta infraestructura, esencial para
                                la
                                Revolución Agraria en la selva central, registra un avance del 90% en la construcción de
                                sus
                                estructuras en ambos estribos.
                                La entrega del proyecto está programada para el segundo semestre de este año y su
                                inversión
                ...
                <div class="swiper-slide">
                    <a href="#" style="text-decoration: none; padding:0px; border:none;">
                        <div class="card">
                            ...
                            <p>Con el objetivo de combatir el dengue en el distrito de San Ramón, el equipo técnico de
                                la
                                Zona Sanitaria, llevó a cabo una jornada exitosa de eliminación de criaderos de
                                zancudos.
                                Durante la intervención, se identificaron y destruyeron focos de reproducción del
                                mosquito
                                Aedes aegypti, responsable de la transmisión del dengue.
                                Esta acción permitió intervenir en zonas críticas, eliminando depósitos de agua
                                acumulada y
                                sensibilizando a los vecinos sobre la importancia de la prevención. Sin embargo,
                                desafíos
                                como viviendas cerradas y algunos pobladores renuentes a colaborar limitaron
                                parcialmente el
                                alcance de la jornada. Ante ello, las autoridades reiteraron la necesidad de la
                                colaboración
