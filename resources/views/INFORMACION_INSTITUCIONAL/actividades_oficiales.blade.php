...
@section('title', 'Actividades Oficiales')
...
@section('contenido-principal')
    <style>
        ...
        .iframe-container iframe {
            width: 1200px; /* Tamaño fijo */
            height: 700px; /* Tamaño fijo */
            max-width: 1200px;
            max-height: 700px;
            border-radius: 15px;
            border: none;
    ...
    <div class="iframe-container fade-in">
        <iframe src="https://calendar.google.com/calendar/embed?src=72659574%40continental.edu.pe&ctz=America%2FLima"
            frameborder="0"
            scrolling="no">
        </iframe>
    </div>
